...
4. **Binder environments and intermediate data dashboards** —  This session begins by introducing [Binder environments](https://mybinder.org/), a tool designed to facilitate public access to our code (e.g., by publishing an RStudio session on the internet). This also allows hosting a dashboard on the internet. Binder is generously free [for the users](https://discourse.jupyter.org/t/mybinder-org-cost-updates/2426). We'll look at the [nuts and bolts of a Binder deployment](https://github.com/binder-examples/r). Attendees may deploy their own Binder environments. Next, in the larger part of this session, we will turn to data dashboards, to gain more advanced experience with each of the possible formats (i.e., [Flexdashboard website](http://rpubs.com/pcbernabeu/Dutch-modality-exclusivity-norms), [Flexdashboard-Shiny app](https://pablobernabeu.shinyapps.io/Dutch-modality-exclusivity-norms/#section-table), [Shiny app](https://pablobernabeu.shinyapps.io/ERP-waveform-visualization_CMS-experiment/)), and with the suitable hosting platforms. This will include an introduction to HTML, CSS and Javascript, which are [the bases for websites](https://www.w3schools.com/whatis/) and thus help in improving the functionality of data dashboards.
