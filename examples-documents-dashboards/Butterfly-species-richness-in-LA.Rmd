...
author: "&nbsp; &nbsp; <a href='https://github.com/pablobernabeu/Data-is-present/blob/master/examples-documents-dashboards/Butterfly-species-richness-in-LA.Rmd' style='color:#FDFFE4; font-size:15px; font-family: Courier New, Courier, monospace' target='_top'> code </a> &nbsp; &nbsp; &nbsp; &nbsp;"
output:
...
# The number of individuals of each butterfly species must be computed from repeated entries, per site.
...
# Compute number of individuals per species in each site, across collection methods
dat = merge(dat, dat %>% count(Species, site, name = 'N_per_species_and_site'))

# Compute number of individuals per species and per collection method, across sites
...
dat[dat$Species=='Adelpha_bredowii', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Adelpha_californica#/media/File:California_Sister_Yosemite.jpg'>Joe Littlejohn<br>(CC Attribution)</a>"
dat[dat$Species=='Agraulis_vanillae', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Gulf_fritillary#/media/File:Agraulis_vanillae_butterfly_from_above.JPG'>Korall<br>(CC Attribution)</a>"
dat[dat$Species=='Brephidium_exilis', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Pygmy_blue_(Brephidium_exilis_thompsoni)_2.JPG'>	
Charles J Sharp<br>(CC Attribution)</a>"
dat[dat$Species=='Colias_eurytheme', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Colias_eurytheme#/media/File:ColiasEurytheme01.jpg'>Greg Hume<br>(CC Attribution)</a>"
dat[dat$Species=='Danaus_gilippus', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Queen_(butterfly)#/media/File:Queen_(Danaus_gilippus_berenice).JPG'>Charles J Sharp<br>(CC Attribution)</a>"
dat[dat$Species=='Danaus_plexippus', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Monarch_butterfly#/media/File:Monarch_In_May.jpg'>Kenneth Dwain Harrelson<br>(CC Attribution)</a>"
dat[dat$Species=='Erynnis_funeralis', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Erynnis_funeralis#/media/File:Erynnis_funeralis_7919.JPG'>Walter Siegmund<br>(CC Attribution)</a>"
dat[dat$Species=='Heliopetes_ericetorum', 'image_licence_table'] = "<a target='_top' href='https://no.wikipedia.org/wiki/Heliopetes#/media/Fil:Turks-cap_white-skipper_(Heliopetes_macaira)_male_+_female_dorsal.jpg'>Anne Toal<br>(CC Attribution)</a>"
dat[dat$Species=='Hylephila_phyleus', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Fiery_Skipper_(Hylephila_phyleus)_%E2%99%82_(7898971392).jpg'>Bob Peterson<br>(CC Attribution)</a>"
dat[dat$Species=='Icaricia_acmon', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Acmon_blue#/media/File:Plebejus_acmon2.jpg'>Calibas<br>(CC Attribution)</a>"
dat[dat$Species=='Junonia_coenia', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Buckeye_Butterfly_(Junonia_coenia).png'>Dr!ppy<br>(CC Attribution)</a>"
dat[dat$Species=='Leptotes_marina', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Marine_blue_(Leptotes_marina).jpg'>Anne Toal<br>(CC Attribution)</a>"
dat[dat$Species=='Lerodea_eufala', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Eufala_Skipper_-_Lerodea_eufala_(26286865559).jpg'>gailhampshire<br>(CC Attribution)</a>"
dat[dat$Species=='Limenitis_lorquini', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Lorquin%27s_admiral#/media/File:Lorquinsadmiral2.jpg'>Calibas<br>(CC Attribution)</a>"
dat[dat$Species=='Nathalis_iole', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Nathalis_iole#/media/File:Nathalis_iole1.jpg'>Tom Peterson<br>(CC Attribution)</a>"
dat[dat$Species=='Nymphalis_antiopa', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Nymphalis_antiopa#/media/File:%D0%9D%D0%B8%D0%BC%D1%84%D0%B0_%D0%B0%D0%BD%D1%82%D0%B8%D0%BE%D0%BF%D0%B0,_%D1%82%D1%80%D0%B0%D1%83%D1%80%D0%BD%D0%B8%D1%86%D0%B0.jpg'>Milantina<br>(CC Attribution)</a>"
dat[dat$Species=='Ochlodes_sylvanoides', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Ochlodes#/media/File:XN_Ochlodes_sylvanus_02.jpg'>Guido Gerding<br>(CC Attribution)</a>"
dat[dat$Species=='Papilio_eurymedon', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Papilio_eurymedon#/media/File:Papilio_eurymedon_000.jpg'>NA<br>(CC Attribution)</a>"
dat[dat$Species=='Papilio_rumiko', 'image_licence_table'] = "<a target='_top' href='https://en.wikipedia.org/wiki/Papilio_rutulus#/media/File:Wtigerswallowtail.JPG'>Calibas<br>(CC Attribution)</a>"
dat[dat$Species=='Papilio_rutulus', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Anise_swallowtail.jpg'>Calibas<br>(CC Attribution)</a>"
dat[dat$Species=='Papilio_zelicaon', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Anise_swallowtail.jpg'>Calibas<br>(CC Attribution)</a>"
dat[dat$Species=='Phoebis_sennae', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Cloudless_sulphur_(Phoebis_sennae_sennae)_male_underside.JPG'>Charles J Sharp<br>(CC Attribution)</a>"
dat[dat$Species=='Pieris_rapae', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Butterfly_Small_White_-_Pieris_rapae_05-1.jpg'>Zeynel Cebeci<br>(CC Attribution)</a>"
dat[dat$Species=='Poanes_melane', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Poanes_melane_(9082154246).jpg'>Donald Hobern<br>(CC Attribution)</a>"
dat[dat$Species=='Pontia_protodice', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Male_Checkered_White,_Megan_McCarty124.jpg'>Megan McCarty<br>(CC Attribution)</a>"
dat[dat$Species=='Pyrgus_albescens', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:White_checkered-skipper_(Pyrgus_albescens)_dorsal.jpg'>Anne Toal<br>(CC Attribution)</a>"
dat[dat$Species=='Strymon_melinus', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Strymon.melinus.01.jpg'>Anita Gould<br>(CC Attribution)</a>"
dat[dat$Species=='Vanessa_annabella', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Marzahn_Gaerten_der_Welt_08-2015_img12_Red_Admiral.jpg'>A.Savin<br>(CC Attribution)</a>"
dat[dat$Species=='Vanessa_atalanta', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:Red_Admiral_(Vanessa_atalanta)_on_ivy_-_geograph.org.uk_-_1519665.jpg'>Andrew Curtis<br>(CC Attribution)</a>"
dat[dat$Species=='Vanessa_cardui', 'image_licence_table'] = "<a target='_top' href='https://commons.wikimedia.org/wiki/File:0_Belle-dame_(Vanessa_cardui)_-_Echinacea_purpurea_-_Havr%C3%A9_(3).jpg'>Jean-Pol GRANDMONT<br>(CC Attribution)</a>"
...
### <span style='font-size: 16px; padding-left: 20px; padding-right: 20px; display: inline-block;'> <a href='https://github.com/jcoliver/BioScan/blob/master/data/BioScanDataComplete.csv' target='_top'> Open data</a> ([iNaturalist](https://github.com/jcoliver/bioscan/blob/master/data/iNaturalist-clean-reduced.csv){style='target:_top;'} and [BioScan](https://github.com/jcoliver/bioscan/blob/master/data/BioScanDataComplete.csv){style='target:_top;'}) from Prudic, K.L.; Oliver, J.C.; Brown, B.V.; Long, E.C. <a href='https://doi.org/10.3390/insects9040186' target='_top'> **Comparisons of Citizen Science Data-Gathering Approaches to Evaluate Urban Butterfly Diversity**. *Insects* **2018**, *9*, 186</a>. Dashboard independently developed by [Pablo Bernabeu](https://github.com/pablobernabeu/Data-is-present/blob/master/README.md){style='target:_top;'}. Searchable [OSM](https://www.tandfonline.com/doi/abs/10.3846/20296991.2016.1160493){style='target:_top;'} map. Hide toolbars at lower right corner.</span> {style="text-align:justify; margin-top:4px; padding-top:15px; padding-bottom: 5px;"}

```{r}

# Format hyperlink to image_link
dat$image_hyperlink = paste0("<a target='_top' href=", dat$image_link, "><img style='max-width:350px; width:100%;' src='", dat$image_link, "' alt='", gsub("_", " ", dat$Species), "'></a>")

# Create links to Google image_links and append to species names, to be shown in pop-ups
dat$Species_link = paste0("<img style='max-height:100px; width:100%; display: block; margin-left: auto; margin-right: auto; width: 50%;' src='", dat$image_link, "' alt='", gsub("_", " ", dat$Species), "'>", '<br><b>', gsub('_', ' ', dat$Species), "</b>. <i>n</i> = ", dat$Number, ' at this site. Sampling: ', dat$Method_source, ". <a href='https://www.google.com/search?q=", gsub('_', '+', dat$Species), "+butterfly' target='_top'>Search further</a>. Image licence: ", dat$image_licence_map, ".")

# Since individuals of different data methods and sources may overlap in the same spot, 
...
leaflet(dat) %>% addTiles() %>%
  addMarkers(~Longitude, ~Latitude, icon = leafIcons,
             ...
             popup = ~as.character(dat$Species_link),
...
#                  label = ~as.character(gsub('_', ' ', dat$Species)), popup = ~as.character(dat$Species_link),
...
### <span style='font-size: 16px; padding-left: 20px; padding-right: 20px; display: inline-block;'> <a href='https://github.com/jcoliver/BioScan/blob/master/data/BioScanDataComplete.csv' target='_top'> Open data</a> ([iNaturalist](https://github.com/jcoliver/bioscan/blob/master/data/iNaturalist-clean-reduced.csv){style='target:_top;'} and [BioScan](https://github.com/jcoliver/bioscan/blob/master/data/BioScanDataComplete.csv){style='target:_top;'}) from Prudic, K.L.; Oliver, J.C.; Brown, B.V.; Long, E.C. <a href='https://doi.org/10.3390/insects9040186' target='_top'> **Comparisons of Citizen Science Data-Gathering Approaches to Evaluate Urban Butterfly Diversity**. *Insects* **2018**, *9*, 186</a>. Dashboard independently developed by [Pablo Bernabeu](https://github.com/pablobernabeu/Data-is-present/blob/master/README.md){style='target:_top;'}. Hide toolbars at lower right corner.</span> {style="text-align:justify; margin-top:4px; padding-top:15px; padding-bottom: 5px;"}

```{r}

# Format text

dat$Species = paste0("<span style=font-size:16px;'>", dat$Species, '</span>')
...
species_dat = dat %>% group_by(image_hyperlink,
                               Species = paste0('<a href="https://www.google.com/search?q=',
                                                gsub('_', '+', dat$Species), '+', ' butterfly" target="_top">',
                                                gsub('_', ' ', dat$Species),'</a>'),
                               wingspan_mm, N_crowdsourcing_iNaturalist,  N_Pollard_Walk_BioScan, 
                               N_malaise_trap_BioScan, N_per_species, image_licence_table) %>%
  dplyr::count()
...
reactable(species_dat[-9],  # Take out last the row corresponding to `dplyr::count()` above
          ...
          columns = list(
            image_hyperlink = colDef(name = ' ', minWidth = 360, filterable = FALSE, sortable = FALSE, html = TRUE),
            Species = colDef(minWidth = 180, filterable = TRUE, html = TRUE),
            image_licence_table = colDef(name = 'Image licence', minWidth = 210, filterable = TRUE, html = TRUE),
            wingspan_mm = colDef(header = with_tooltip('Wingspan', "Average wingspan in millimeters")),
            N_crowdsourcing_iNaturalist = colDef(minWidth = 155, header = with_tooltip('N crowdsourcing',
            ...
            N_per_species = colDef(name = 'N total')
          ))
